...
tyt_pairs = [
(0,1),(1,2),(2,4),(4,6),(1,3),(3,5),(5,7),(1,8),(8,11),(8,10),(10,11),(9,12)
]
...
class Feeder(Dataset):
    ...
    def __getitem__(self, ind):
        ...
        data_numpy = torch.Tensor(np.resize(data_numpy,(256,256,3))).permute(2,0,1) #self.transforms(data_numpy)
